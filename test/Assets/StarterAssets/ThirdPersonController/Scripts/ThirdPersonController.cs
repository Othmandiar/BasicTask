...
namespace StarterAssets
{
	...
	public class ThirdPersonController : MonoBehaviour
	{
        ...
        // player
        private float _speed, timeToRepressed = 999999,timeToTurnTextOff=999999;
        ...
        public void randomAnimation()
        {
            ...
            _animator.SetBool(animDanceNames[r], true);
        }
        ...
        public void setFalse()
        {
            for (int i = 0; i < 3; i++)
            {
                _animator.SetBool(animDanceNames[i], false);
            }
